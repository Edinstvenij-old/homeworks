...
if (missingInfo.length > 0) {
  ...
  if (isNaN(birthYearNum)) {
    alert("Год рождения должен быть числом. Пожалуйста, проверьте введенные данные.");
  } else {
    // Расчет возраста
    ...
    if (age < 0) {
      alert("Вы указали год рождения, который больше текущего. Пожалуйста, проверьте введенные данные.");
    } else if (age < 12) {
      alert("Ваш возраст слишком мал (меньше 12 лет). Пожалуйста, проверьте введенные данные.");
    } else {
